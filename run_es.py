...
parser.add_argument(
    "--learning_rate", type=float, default=0.01, help="Learning rate for ES optimizer"
)
parser.add_argument(
    "--l2_coefficient",
    type=float,
...
# NSES
parser.add_argument(
    "--nses_emitter", type=bool, default=False, help="Use NSES instead of ES"
)
parser.add_argument(
...
parser.add_argument(
    "--actor_injection", action="store_true", default=False, help="Use actor injection"
)
parser.add_argument(
    "--injection_clip",
    action="store_true",
...
parser.add_argument(
    "--critic_training", type=int, default=1000, help="Number of critic training steps"
)
parser.add_argument(
...
parser.add_argument(
    "--surrogate_omega", type=float, default=0.6, help="Probability of using surrogate"
)
parser.add_argument(
    "--spearman",
    default=False,
...
repertoire, emitter_state, random_key = es.init(init_variables, centroids, random_key)
